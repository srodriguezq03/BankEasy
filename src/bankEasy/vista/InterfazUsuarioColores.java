...
public class InterfazUsuarioColores {
	 ...
	 */
	public void start() {
		System.out.println(ANSI_BRIGHT_GREEN + "¡Bienvenido a BankEasy!" + ANSI_RESET);
		usuarios.add(
	...
	public void mostrarMenuAdministrador() {
		...
		do {
			System.out.println(ANSI_BRIGHT_BLUE + "\n[ADMINISTRADOR]\n" + "1. Crear cuenta bancaria\n"
					+ "2. Borrar cuenta bancaria\n" + "3. Volver a la pantalla anterior" + ANSI_RESET);
			opcion = introducirInput(ANSI_BRIGHT_CYAN + "Elija una opción:\n> " + ANSI_RESET);
	...
	public void mostrarMenuCliente(Usuario usuario) {
		...
		do {
			System.out.println(ANSI_BRIGHT_BLUE + "\n[CLIENTE]\n" + "1. Realizar transferencia\n"
					...
					+ "5. Volver a la pantalla anterior" + ANSI_RESET);
			opcion = introducirInput(ANSI_BRIGHT_CYAN + "Elija una opción:\n> " + ANSI_RESET);

			switch (opcion) {
			case "1":
				nombreDestino = introducirInput(ANSI_BRIGHT_CYAN
